...
function Footer() {
  return (
    <footer className="w-full py-1 bg-gray-50">
      <div className="sm:w-[1200px] w-full mx-auto px-4 sm:px-0">
        <div className="text-center mb-16">
          <div className="text-4xl font-bold mb-4 text-center">
          </div>
            </div>
        <div className="sm:grid sm:grid-cols-2 sm:gap-10 justify-center items-center">
          <div className="mb-10 flex justify-center">
            <InputFooter
              onSubmit={handleContact} />
          </div>
          <div className="sm:w-[745px] w-[325px] mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 mx-auto">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d43454.82628357475!2d10.877405457839885!3d49.58806023405201!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47a2012a6dd6455d%3A0xcd2bb5b125f1e930!2sAdi-Dassler-Stra%C3%9Fe%201%2C%2091074%20Herzogenaurach%2C%20Germany!5e0!3m2!1sen!2sid!4v1772508308141!5m2!1sen!2sid" 
                className="sm:w-[600px] sm:h-[450px] w-full rounded-lg" loading="lazy" 
                referrerpolicy="no-referrer-when-downgrade">
              </iframe>
              <div className="flex mt-8 gap-3 justify-center">
                {cards.map((card, index) => ( 
                  <div key={index}>
                    <img src={card.image} className="w-[25px] h-[25px]" />
                  </div>
                ))}
              </div>
            </div>
