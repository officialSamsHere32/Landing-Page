...
function Banner() {
  return (
    <>
      <section className="lg:hidden w-full flex justify-center py-24  sm:[background:linear-gradient(240deg,rgba(39,245,111),rgba(19,110,52)_100%)] [background:linear-gradient(240deg,rgba(39,245,111),rgba(19,110,52)_100%)]">
